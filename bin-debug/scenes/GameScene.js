...
var GameScene = (function (_super) {
    ...
    GameScene.prototype.backClick = function () {
        return __awaiter(this, void 0, void 0, function () {
            var backNum, result, operate, sourceIndex, targetIndex;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        backNum = PlayerData.Instance.backNum;
                        if (!(backNum <= 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, WXAdManager.Instance.ShowRewardAd()];
                    case 1:
                        result = _a.sent();
                        if (result == true) {
                    ...
                    case 2:
                        ...
                        sourceIndex = operate.src;
                        targetIndex = operate.tar;
    ...
    GameScene.prototype.addTubeClick = function () {
        return __awaiter(this, void 0, void 0, function () {
            var newTubeNum, result, waterDatas, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newTubeNum = PlayerData.Instance.newTubeNum;
                        if (!(newTubeNum <= 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, WXAdManager.Instance.ShowRewardAd()];
                    case 1:
                        result = _a.sent();
                        if (result == true) {
    ...
    GameScene.prototype.OnThemeChanged = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
